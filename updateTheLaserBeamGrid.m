...
function p = updateTheLaserBeamGrid(angle, range, Tl, R, C, Xmax, Ymax)
global Bitmap;
...
Bitmap(I2, J2) = Bitmap(I2, J2)+ .1 ;
if Bitmap(I2, J2)>1;  Bitmap(I2, J2)=1;end
...
for k=1:length(l)-1 %skip the target pixel
    ...
    if Bitmap(l(k,1),l(k,2)) <0 ; Bitmap(l(k,1),l(k,2))=0;end
end
